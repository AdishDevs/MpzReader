...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MpzReader/MpzReader.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/R2Navigator/R2Navigator.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/R2Shared/R2Shared.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/R2Streamer/R2Streamer.framework"
